...
class PactContextSpec extends ObjectBehavior
{
    ...
    public function let(Pact $pact, ProviderState $providerState, Authenticator $authenticator): void
    {
    ...
    public function it_registers_interaction(Pact $pact): void
    {
    ...
    public function it_registers_interaction_with_body(Pact $pact): void
    {
    ...
    public function it_registers_interaction_with_complex_body(Pact $pact): void
    {
    ...
    public function it_registers_interaction_with_query(Pact $pact): void
    {
        $pact->registerInteraction(Argument::any(), Argument::any(), Argument::any())->shouldBeCalled();
    ...
    public function it_registers_interaction_with_query_and_body(Pact $pact): void
    {
    ...
    public function it_registers_interaction_with_query_and_complex_body(Pact $pact): void
    {
        $response = new stdClass();
        $pact->registerInteraction(Argument::any(), Argument::any(), Argument::any())->shouldBeCalled();
        $this->registerInteractionWithQueryAndBody(
    ...
    public function it_remember_request_to_provider_with_parameters(): void
    {
    ...
    public function it_registers_response_for_the_stored_request(Pact $pact): void
    {
        $requestTable = new TableNode([1 => ['val1', 'val2']]);
        $this->requestToWithParameters(self::PROVIDER_NAME, 'GET', '/', $requestTable);
    ...
    public function it_requires_request_be_defined_before_register_response_to_complex_request(Pact $pact): void
    {
        $responseTable = new TableNode([1 => ['val1', 'val2']]);
    ...
    public function it_defines_object_structure_for_matcher(): void
    {
        $table = new TableNode([1 => ['val1', 'val2']]);
        $this->hasFollowStructureInTheResponseAbove('<objectName>', $table)->shouldBe(true);
    }

    public function it_requires_proper_object_name_for_the_structure_definition(): void
    {
        $table = new TableNode([1 => ['val1', 'val2']]);
        $this->shouldThrow(
    ...
    public function it_start_mock_server_for_api(Pact $pact): void
    {
        $pact->startServer(self::PROVIDER_NAME)->shouldBeCalled();
        $this->mockedApiProviderIsAvailable(self::PROVIDER_NAME)->shouldBeInt();
    }

    public function it_registers_entity_for_the_provider_state(ProviderState $providerState): void
    {
    ...
    public function it_registers_entity_with_description_for_the_provider_state(ProviderState $providerState): void
    {
        $providerState->addInjectorState(Argument::any())->shouldBeCalled();
        $table = new TableNode([1 => ['val1', 'val2']]);
    ...
    public function it_registers_plain_text_provider_state(ProviderState $providerState): void
    {
    ...
    public function it_http_authorize_consumer_on_provider(Authenticator $authenticator): void
    {
    ...
    public function it_skip_verify_interaction_when_pact_tag_missed(Pact $pact): void
    {
        $pact->verifyInteractions()->shouldNotBeCalled();
        $pact->cleanupInteractions()->shouldBeCalled()->willReturn(true);

        $this->verifyInteractions();
    }

    public function it_verify_interaction_when_pact_tag_added(
        Pact $pact,
        ScenarioScope $scope,
        Scenario $scenario
    ): void {
    ...
    public function it_fanalizes_pact_on_tests_success(
        Pact $pact,
        ...
        $this->teardown(
            new AfterSuiteScope(
                $environment->getWrappedObject(),
                $iterator->getWrappedObject(),
                $testResult->getWrappedObject()
            )
        );
    }

    public function it_ignores_fanalizes_pact_on_tests_failed(
        Pact $pact,
        Environment $environment,
        SpecificationIterator $iterator,
        TestResult $testResult
